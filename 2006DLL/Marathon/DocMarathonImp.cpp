...
void Sonicteam::DocMarathonImp::EngineDocOnUpdate(float)
{

}

void Sonicteam::DocMarathonImp::EngineDocDomeSome()
{
...
Sonicteam::SoX::Graphics::FrameSynchronizer* Sonicteam::DocMarathonImp::DocGetFrameSynchronizer()
{
return 0;
}

...
namespace Sonicteam { namespace Prop {
	...
	struct SceneActor{
		unsigned int Flag1;
		unsigned int Flag2;
		unsigned int ObjActorHandle; // Sonicteam::Prop::EntityHandle
	...
	public:
		...
		Sonicteam::Prop::SceneData* ScenePropData; // Sonicteam::Prop::SceneData: //0x1C
		unsigned int ScenePropFile; // Pointer to .set file in memory  (right after BBINA padded 0x10) //0x20
		Sonicteam::Prop::AllocatedData* ScenePropAllocatedData; // Sonicteam::Prop::AllocatedData //0x24
		std::vector<Sonicteam::Prop::Instance> ScenePropInstance; // Sonicteam::Prop::Instance //0x28
		...
		std::vector<SceneActor> SceneObject; // 0x70

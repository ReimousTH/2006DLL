...
namespace Sonicteam { class GameImp; namespace Prop {
	...
	public:
		...
		std::vector<Sonicteam::Prop::Scene> ManagerPropScenes; // ?? unknown typwe //0x20-0x2C // Sonicteam::Prop::Scene //0x20
		...
		boost::shared_ptr<Sonicteam::Prop::ActorCreators> ActorCreators; // boost::shared_ptr<Sonicteam::Prop::ActorCreators> //0x3C-0x40
